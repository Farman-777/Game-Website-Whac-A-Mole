...
import "./GameMouseLevel2.css";
import Confetti from "react-confetti";
import Swal from "sweetalert2";

const GameMouseLevel2 = () => {
  ...
  return (
    <div>
      {gameStarted ? ( // Button is hidden when game is started
        ...
        <button className="back-Button-medium" onClick={handleclickBack}>
          <FontAwesomeIcon icon={faArrowLeft} />
        </button>
      )}
      <div
        className="main-container-level2"
        style={
          gameStarted
            ? {
                marginTop: "0px",
      ...
      >
        <h1 className="game-title-level2">Whac A Mole</h1>
        <button
          type="button"
          className="start-button-level2"
        ...
        {gameStarted && (
          <div className="game-container-level2">
            <div className="level2-part-1">
              <div
                className="Inner-box-level2"
                style={{
...
export default GameMouseLevel2;
